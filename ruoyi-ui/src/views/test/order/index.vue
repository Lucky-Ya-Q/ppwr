<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="购买人手机号" align="center" prop="buyerPhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="购买人手机号" prop="buyerPhone">
          <el-input v-model="form.buyerPhone" placeholder="请输入购买人手机号" />
        </el-form-item>
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder } from "@/api/test/order";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('test/order/export', {
        ...this.queryParams
